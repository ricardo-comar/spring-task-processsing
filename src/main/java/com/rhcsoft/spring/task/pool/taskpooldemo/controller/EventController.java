...
public class EventController {
    ...
    @PatchMapping("/reprocess/{id}")
    public ResponseEntity<EventDoc> reprocessData(@PathVariable String id) {

        LOGGER.info("Event reprocess requested: " + id);
        eventDocProcessor.processEvent(id);
